...
var opts={};if(Object.assign==undefined){for(var key 在 defaultopts){if(option[key]==undefined){opts[key]=defaultopts[key];}else{opts[key]=option[key];}}}else{opts=Object.assign(defaultopts,option);}
...
openobj.ChangeBefore();var 文件=_this.文件;var isMultiple=_this.hasAttribute('multiple');if(files.length==0){FileEmpty(function(){console.log("未选中文件");});return false;}
